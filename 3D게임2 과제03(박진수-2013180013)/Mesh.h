...
public:
	CBillboardVertex() { m_xmf3Position = XMFLOAT3(0.0f, 0.0f, 0.0f); m_xmf2Size = XMFLOAT2(0.0f, 0.0f); m_nTexture = 0; }
	CBillboardVertex(XMFLOAT3 xmf3Position, XMFLOAT2 xmf2Size, UINT nTexture) { m_xmf3Position = xmf3Position; m_xmf2Size = xmf2Size; m_nTexture = nTexture; }
	~CBillboardVertex() { }
};
...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, UINT nInstance);
};
...
{
public:
	CHierarchyMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList);
	virtual ~CHierarchyMesh();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CStandardHierarchyMesh : public CHierarchyMesh
{
public:
	CStandardHierarchyMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList);
	virtual ~CStandardHierarchyMesh();
