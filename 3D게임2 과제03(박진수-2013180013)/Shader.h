...
public:
	...
	void CreateShaderResourceViews(ID3D12Device *pd3dDevice, CTexture *pTexture, UINT nRootParameterStartIndex, bool bAutoIncrement);
...
public:
	...
	virtual D3D12_SHADER_BYTECODE CreateVertexShader(ID3DBlob **pd3dVertexShaderBlob);
	virtual D3D12_SHADER_BYTECODE CreatePixelShader(ID3DBlob **pd3dVertexShaderBlob);
