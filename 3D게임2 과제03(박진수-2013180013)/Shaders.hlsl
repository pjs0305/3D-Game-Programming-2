...
Texture2D gtxtAlbedoTexture : register(t10);
Texture2D gtxtSpecularTexture : register(t11);
Texture2D gtxtNormalTexture : register(t12);
Texture2D gtxtMetallicTexture : register(t13);
Texture2D gtxtEmissionTexture : register(t14);
Texture2D gtxtDetailAlbedoTexture : register(t15);
Texture2D gtxtDetailNormalTexture : register(t16);
