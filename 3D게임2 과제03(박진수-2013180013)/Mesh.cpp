...
//	CTexturedVertex *pVertices = new CTexturedVertex[m_nVertices];
	...
	for (int i = 0, z = zStart; z < (zStart + nLength); z++)
	{
		for (int x = xStart; x < (xStart + nWidth); x++, i++)
		{
			...
			pVertices[i].m_iTexture = (fColor >  250.0f) ? 1 : 2;
...
CHierarchyMesh::CHierarchyMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
}

CHierarchyMesh::~CHierarchyMesh()
{
...
void CHierarchyMesh::ReleaseUploadBuffers()
{
...
void CHierarchyMesh::Render(ID3D12GraphicsCommandList *pd3dCommandList, int nSubSet)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
...
CStandardHierarchyMesh::CStandardHierarchyMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList) : CHierarchyMesh(pd3dDevice, pd3dCommandList)
{
}

CStandardHierarchyMesh::~CStandardHierarchyMesh()
{
...
void CStandardHierarchyMesh::ReleaseUploadBuffers()
{
	CHierarchyMesh::ReleaseUploadBuffers();
...
void CStandardHierarchyMesh::LoadMeshFromFile(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, FILE *pInFile)
{
	char pstrToken[64] = { '\0' };
	BYTE nStrLength = 0;
...
void CStandardHierarchyMesh::Render(ID3D12GraphicsCommandList *pd3dCommandList, int nSubSet)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
