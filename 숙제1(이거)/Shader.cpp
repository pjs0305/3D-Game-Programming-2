...
void CBillboardObjectsShader::Render(ID3D12GraphicsCommandList *pd3dCommandList)
{
	CObjectsShader::Render(pd3dCommandList);
}
...
void CInstancingBillboardObjectsShader::OnPrepareRender(ID3D12GraphicsCommandList *pd3dCommandList)
{
	if (m_ppd3dPipelineStates) pd3dCommandList->SetPipelineState(m_ppd3dPipelineStates[0]);
...
void CInstancingBillboardObjectsShader::Render(ID3D12GraphicsCommandList *pd3dCommandList)
{
	OnPrepareRender(pd3dCommandList);
...
D3D12_SHADER_BYTECODE CFlowerObjectsShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
...
D3D12_SHADER_BYTECODE CTreeObjectsShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CompileShaderFromFile(L"Shaders.hlsl", "PSInstancingTextured", "ps_5_1", ppd3dShaderBlob));
}
