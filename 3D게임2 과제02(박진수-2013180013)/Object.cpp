...
void CGameObject::Render(ID3D12GraphicsCommandList *pd3dCommandList, UINT PipelineStateIndex)
{
	OnPrepareRender();
	...
	if (m_pMaterial)
	{
		if (m_pMaterial->m_pShader)
		{
			m_pMaterial->m_pShader->Render(pd3dCommandList, PipelineStateIndex);
			m_pMaterial->m_pShader->UpdateShaderVariables(pd3dCommandList);
...
void CGameObject::Render(ID3D12GraphicsCommandList *pd3dCommandList, UINT PipelineStateIndex, UINT nInstance)
{
	OnPrepareRender();
