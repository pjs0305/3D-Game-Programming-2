...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, UINT PipelineStateIndex);
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, UINT PipelineStateIndex, UINT nInstance);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
struct CB_BILLBOARDGAMEOBJECT_INFO
{
	XMFLOAT4X4						m_xmf4x4World;
	UINT							m_nTexture;
};
...
public:
	...
	float m_fRotationDelta = 3.0f;

protected:
	CB_BILLBOARDGAMEOBJECT_INFO		*m_pcbMappedGameObject = NULL;
